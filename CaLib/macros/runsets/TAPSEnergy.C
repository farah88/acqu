...
void Fit(Int_t run)
{
    ...
    gFitFunc->SetParLimits(1, 90, 150);  
    gFitFunc->SetParLimits(2, 5, 15);
    Int_t fitres;
    ...
    // get position
    Float_t fPi0Pos = gFitFunc->GetParameter(1);
...
void TAPSEnergy()
{
    ...
    TFile* fout = new TFile("/hiskp2/afzal/Mainz/Nov13/calibration/time/runset_overview_energyLG.root", "recreate");
    cOverview->Write();
    delete fout;
